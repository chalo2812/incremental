...
import {
  FiCalendar, FiTag, FiUserCheck, FiShuffle,
  FiAlertTriangle, FiShield, FiCheckCircle, FiClock,
} from "react-icons/fi";
...
export default function Dashboard({ username, onLogout, sessionTimeoutMinutes = 5 }: DashboardPropsExt) {
  ...
  const template = activeSection === "overview" ? null : projectTemplates[project]?.[activeSection];
      ...
      <div className="dashboard-wrapper">
        ...
        <main className="main-panel">
          {activeSection === "overview" ? (
            ...
            <SectionPage section={activeSection} template={template} />
          ) : (
